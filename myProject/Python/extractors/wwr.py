...
def extract_wwr_jobs(keyword):
    ...
    #reponse.status_code로 status_code 확인 만약 status_code 가 200이라면 정상적인 상태
        print("Can't request website")
    else: 
        results = []
   # print(response.text, "html.parser") #reponse로 하면 숫자값 text로 하면 구성하고 있는 전체 html코드를 확인 할 수 있음 
